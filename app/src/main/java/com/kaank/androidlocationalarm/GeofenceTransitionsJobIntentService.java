   ...
   /* @Override
    public int onStartCommand(@Nullable Intent intent, int flags, int startId) {
        ...
        Notification notification = new NotificationCompat.Builder(this, "ServiceChannel")
                ...
                .setSmallIcon(R.drawable.ic_twotone_location_on_48px)
    ...
    private String getGeofenceTransitionDetails(
        ...
        Reminder reminder =Utils.get(getApplicationContext(),triggeringGeofencesIdsList.get(triggeringGeofencesIdsList.size()-1));

        return geofenceTransitionString + ": " + reminder.message;
    }
    ...
    private void sendNotification(String notificationDetails) {
        ...
        builder.setSmallIcon(R.drawable.ic_twotone_location_on_48px)
